...
},{"./MIDIFileHeader":4,"./MIDIFileTrack":5,"midievents":2,"utf-8":9}],4:[function(require,module,exports){
'use strict';
...
},{"midievents":2}],7:[function(require,module,exports){
...
},{"string.fromcodepoint":7,"string.prototype.codepointat":8}],10:[function(require,module,exports){
'use strict';
...
var MIDILyricsDisplayer = require('./MIDILyricsDisplayer');
...
Application.prototype.play = function() {
  var playTime;
  if(
    (playTime = this.midiPlayer.play(this.endCallback.bind(this))) ||
...
Application.prototype.backward = function() {
};
...
Application.prototype.volume = function(event, params) {
  ...
  if('less' === params.type) {
    this.midiPlayer.volume =
      10 > this.midiPlayer.volume ?
      0 :
      this.midiPlayer.volume - 10;
  } else if('more' === params.type) {
    this.midiPlayer.volume =
      90 < this.midiPlayer.volume ?
        100 :
        this.midiPlayer.volume + 10;
...
Application.prototype.selectOutput = function() {
...
Application.prototype.selectFile = function() {
  ...
  this.downloadFile('/sounds/' + event.target.value);
};
...
},{"./MIDILyricsDisplayer":11,"commandor":1,"midifile":3,"midiplayer":6}],11:[function(require,module,exports){
'use strict';
